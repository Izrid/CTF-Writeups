...
![screenshot of challenge with the flag cutoff](nathan_on_osu.png)
...
![distorted screenshot](<acropalypse distorted.png>)
...
![full screenshot from cropped](full_picture.png)
